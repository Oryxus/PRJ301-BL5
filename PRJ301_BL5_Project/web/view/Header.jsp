...
<section class="jumbotron text-center">
    <div class="container">
        <h1 class="jumbotron-heading">Siêu thị linh kiện PC Gaming chất lượng cao</h1>
        <p class="lead text-muted mb-0">Uy tín tạo nên thương hiệu với hơn 10 năm cung cấp các sản phẩm Gaming Gear chính hãng tại Việt Nam</p>
    </div>
</section>
<!--end of menu-->
